...
void Binding::initialize(const glscbinding::GetProcAddress functionPointerResolver, const bool resolveFunctions)
{
...
,   const glscbinding::GetProcAddress functionPointerResolver
...
int & Binding::s_pos()
{
    GLSCBINDING_THREAD_LOCAL int pos = 0;
    //static int pos = 0;
...
{
    GLSCBINDING_THREAD_LOCAL ContextHandle context = 0;
    //static ContextHandle context = 0;

    return context;
}

glscbinding::GetProcAddress & Binding::s_getProcAddress()
{
    GLSCBINDING_THREAD_LOCAL glscbinding::GetProcAddress getProcAddress = nullptr;
    //static glscbinding::GetProcAddress getProcAddress = nullptr;
...
glscbinding::GetProcAddress & Binding::s_firstGetProcAddress()
{
    static glscbinding::GetProcAddress getProcAddress = nullptr;
