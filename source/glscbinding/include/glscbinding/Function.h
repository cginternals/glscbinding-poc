...
*/
template <typename ReturnType, typename... Arguments>
struct GLSCBINDING_TEMPLATE_API CallbackType
{
...
struct GLSCBINDING_TEMPLATE_API CallbackType<void, Arguments...>
{
...
*/
template <typename ReturnType, typename... Arguments>
class GLSCBINDING_TEMPLATE_API Function : public AbstractFunction
{
public:
...
#include <glscbinding/Function.inl>