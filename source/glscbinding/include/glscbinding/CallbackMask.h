...
*/
GLSCBINDING_CONSTEXPR inline CallbackMask operator~(CallbackMask a);
...
*/
GLSCBINDING_CONSTEXPR inline CallbackMask operator|(CallbackMask a, CallbackMask b);
...
#include <glscbinding/CallbackMask.inl>