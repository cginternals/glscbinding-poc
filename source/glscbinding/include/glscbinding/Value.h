...
*/
template <typename T>
class GLSCBINDING_TEMPLATE_API Value : public AbstractValue
{
public:
    /**
    *  @brief
    ...
    */
    GLSCBINDING_CONSTEXPR inline Value(const T & value);
    ...
    *    The value
    */
    GLSCBINDING_CONSTEXPR inline T value() const;
