...
#include <glscbinding-aux/logging.h>
...
#include <glscbinding-aux/RingBuffer.h>
...
using FunctionCallBuffer = glscbinding::aux::RingBuffer<glscbinding::aux::LogEntry>;
...
std::ostream & operator<<(std::ostream & stream, const glscbinding::FunctionCall * call)
{
...
{
    Binding::setLogCallback(glscbinding::aux::log);
